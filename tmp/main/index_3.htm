...
<html lang="zxx">
	...
	<body>
		...
		<section class="m-t-30">
			<div class="container text-center">
				...
				<div class="thumb p-30">
					<div class="banner banner-2x bg-img-3 bg-8 text-left  no-bg-img-xs ">
						<div class="caption">
							<h1 class="heading-size-4 f-normal">Great gift idea</h1>
							<h2 class="heading-size-1">For kids</h2>
							<div class="heading-size-2 color-tran"><span class="heading-size-4 color-tran price-old">$237</span> $176.0</div>
							<a href="#" class="btn ht-btn ht-btn-2x">Shop now</a>
						</div>
					</div>
				</div>
			</div>
		...
		<section>
			<div class="container">
				<div class="banner banner-2x banner-1 bg-img-4 bg-white bor-rand-15 no-bg-img-xs">
					<div class="caption">
						<h4 class="heading-size-5">from 4-15 may</h4>		
						<h2 class="heading-size-2 f-bold">Sale Extra 46%</h2>
						<h3 class="heading-size-3 color-3 f-normal">on all order</h3>
						<a href="#" class="btn ht-btn ht-btn-2x bg-4">Shop now</a>
					</div>
				</div>
			</div>
		</section>
		...
		<!-- Brand logo -->
		<div class="process m-t-60">
			<div class="container">
				<div class="brand m-t-20">
					<div class="row">
						<div class="owl" data-items="6" data-itemsDesktop="5" data-itemsDesktopSmall="3" data-itemsTablet="2" data-itemsMobile="1" data-transitionstyle="backslide" data-singleItem="false" data-autoplay="3000" data-pag="false" data-buttons="false">
							<div class="col-lg-12">
								<a href="#"><img src="images/log1.png" alt="image"></a>
							</div>
							<div class="col-lg-12">
								<a href="#"><img src="images/log2.png" alt="image"></a>
							</div>
							<div class="col-lg-12">
								<a href="#"><img src="images/log3.png" alt="image"></a>
							</div>
							<div class="col-lg-12">
								<a href="#"><img src="images/log4.png" alt="image"></a>
							</div>
							<div class="col-lg-12">
								<a href="#"><img src="images/log5.png" alt="image"></a>
							</div>
							<div class="col-lg-12">
								<a href="#"><img src="images/log6.png" alt="image"></a>
							</div>
						</div>
					</div>
				</div>
